 ...
 */
class BLESPPUtils {
    private static final boolean mEnableLogOut = false;
    private final Context mContext;
    private final BluetoothAdapter mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
    private final OnBluetoothAction mOnBluetoothAction;
    private final ConnectTask mConnectTask = new ConnectTask();
